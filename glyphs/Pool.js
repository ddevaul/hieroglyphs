...
export default class Pool {
  constructor(length) {
    ...
    this.line1Points = [
      ...
      [{"x": 325, "y": 235},{"x": 325, "y": 235},{"x": 75, "y": 235},{"x": 75, "y": 235},],
      [{"x": 75, "y": 235},{"x": 75, "y": 235},{"x": 75, "y": 165},{"x": 75, "y": 165},],
    ]
  }
  ...
  shape = (color, maxSegmentIndex, reveal) => {
    ...
    return (
      <>
        ...
        <>
          <Path d={`M ${(75 / 400 * this.length)} ${(165 / 400 * this.length)} C ${(75 / 400 * this.length)} ${(165 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(165 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(165 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(325 / 400 * this.length)} ${(165 / 400 * this.length)} C ${(325 / 400 * this.length)} ${(165 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(235 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(235 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(325 / 400 * this.length)} ${(235 / 400 * this.length)} C ${(325 / 400 * this.length)} ${(235 / 400 * this.length)}, ${(75 / 400 * this.length)} ${(235 / 400 * this.length)}, ${(75 / 400 * this.length)} ${(235 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(75 / 400 * this.length)} ${(235 / 400 * this.length)} C ${(75 / 400 * this.length)} ${(235 / 400 * this.length)}, ${(75 / 400 * this.length)} ${(165 / 400 * this.length)}, ${(75 / 400 * this.length)} ${(165 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
      </>
    )
