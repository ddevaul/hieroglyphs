...
export default class Snake {
  constructor(length) {
    ...
    this.line1Points = [
      ...
      [{"x": 110, "y": 210},{"x": 110, "y": 210},{"x": 112, "y": 212},{"x": 115, "y": 212},],
      [{"x": 115, "y": 212},{"x": 115, "y": 212},{"x": 160, "y": 210},{"x": 175, "y": 207},],
      [{"x": 175, "y": 207},{"x": 175, "y": 207},{"x": 180, "y": 205},{"x": 190, "y": 207},],
      [{"x": 190, "y": 207},{"x": 190, "y": 207},{"x": 260, "y": 230},{"x": 310, "y": 230},],
    ]
    this.line2Points = [
      [{"x": 50, "y": 170},{"x": 50, "y": 170},{"x": 60, "y": 190},{"x": 60, "y": 190},]
    ]
    this.line3Points = [
      [{"x": 77, "y": 170},{"x": 77, "y": 170},{"x": 70, "y": 190},{"x": 70, "y": 190},]
    ]
  }
  ...
  shape = (color, maxSegmentIndex, reveal) => {
    ...
    return (
      <>
        ...
        <>
          <Path d={`M ${(50 / 400 * this.length)} ${(190 / 400 * this.length)} C ${(50 / 400 * this.length)} ${(190 / 400 * this.length)}, ${(85 / 400 * this.length)} ${(190 / 400 * this.length)}, ${(85 / 400 * this.length)} ${(190 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(85 / 400 * this.length)} ${(190 / 400 * this.length)} C ${(85 / 400 * this.length)} ${(190 / 400 * this.length)}, ${(90 / 400 * this.length)} ${(190 / 400 * this.length)}, ${(110 / 400 * this.length)} ${(210 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(110 / 400 * this.length)} ${(210 / 400 * this.length)} C ${(110 / 400 * this.length)} ${(210 / 400 * this.length)}, ${(112 / 400 * this.length)} ${(212 / 400 * this.length)}, ${(115 / 400 * this.length)} ${(212 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(115 / 400 * this.length)} ${(212 / 400 * this.length)} C ${(115 / 400 * this.length)} ${(212 / 400 * this.length)}, ${(160 / 400 * this.length)} ${(210 / 400 * this.length)}, ${(175 / 400 * this.length)} ${(207 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(175 / 400 * this.length)} ${(207 / 400 * this.length)} C ${(175 / 400 * this.length)} ${(207 / 400 * this.length)}, ${(180 / 400 * this.length)} ${(205 / 400 * this.length)}, ${(190 / 400 * this.length)} ${(207 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(190 / 400 * this.length)} ${(207 / 400 * this.length)} C ${(190 / 400 * this.length)} ${(207 / 400 * this.length)}, ${(260 / 400 * this.length)} ${(230 / 400 * this.length)}, ${(310 / 400 * this.length)} ${(230 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        
        </>
          : <></>}
        {(maxSegmentIndex > 1 || reveal) ? 
        <>
          <Path d={`M ${(50 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(50 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(60 / 400 * this.length)} ${(190 / 400 * this.length)}, ${(60 / 400 * this.length)} ${(190 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
          : <></>}
        {(maxSegmentIndex > 2 || reveal) ? 
        <>
          <Path d={`M ${(77 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(77 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(70 / 400 * this.length)} ${(190 / 400 * this.length)}, ${(70 / 400 * this.length)} ${(190 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
          : <></>}
      </>
    )
