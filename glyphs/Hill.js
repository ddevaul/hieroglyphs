...
export default class Hill {
  constructor(length) {
    ...
    this.line1Points = [
      ...
      [{"x": 280, "y": 140},{"x": 280, "y": 140},{"x": 280, "y": 290},{"x": 280, "y": 290},],
      [{"x": 280, "y": 290},{"x": 280, "y": 290},{"x": 100, "y": 290},{"x": 100, "y": 290},],
    ]
  }
  ...
  shape = (color, maxSegmentIndex, reveal) => {
    ...
    return (
      <>
        ...
        <>
          <Path d={`M ${(100 / 400 * this.length)} ${(290 / 400 * this.length)} C ${(175 / 400 * this.length)} ${(250 / 400 * this.length)}, ${(205 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(220 / 400 * this.length)} ${(140 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(220 / 400 * this.length)} ${(140 / 400 * this.length)} C ${(230 / 400 * this.length)} ${(100 / 400 * this.length)}, ${(270 / 400 * this.length)} ${(90 / 400 * this.length)}, ${(280 / 400 * this.length)} ${(140 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(280 / 400 * this.length)} ${(140 / 400 * this.length)} C ${(280 / 400 * this.length)} ${(140 / 400 * this.length)}, ${(280 / 400 * this.length)} ${(290 / 400 * this.length)}, ${(280 / 400 * this.length)} ${(290 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(280 / 400 * this.length)} ${(290 / 400 * this.length)} C ${(280 / 400 * this.length)} ${(290 / 400 * this.length)}, ${(100 / 400 * this.length)} ${(290 / 400 * this.length)}, ${(100 / 400 * this.length)} ${(290 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
          : <></>}
      </>
    )
