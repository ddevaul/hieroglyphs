    ...
    return (
      <>
       {/* falcons head */}
        ...
        <>
          <Path d={`M ${(180 / 400 * this.length)} ${(30 / 400 * this.length)} C ${(220 / 400 * this.length)} ${(60 / 400 * this.length)}, ${(220 / 400 * this.length)} ${(60 / 400 * this.length)}, ${(220 / 400 * this.length)} ${(60 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(220 / 400 * this.length)} ${(60 / 400 * this.length)} C ${(220 / 400 * this.length)} ${(360 / 400 * this.length)}, ${(220 / 400 * this.length)} ${(360 / 400 * this.length)}, ${(220 / 400 * this.length)} ${(360 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
          : <></>}
        
        {(maxSegmentIndex > 1 || reveal) ? 
        <>
          <Path d={`M ${(180 / 400 * this.length)} ${(30 / 400 * this.length)} C ${(140 / 400 * this.length)} ${(240  / 400 * this.length)}, ${(140 / 400 * this.length)} ${(240 / 400 * this.length)}, ${(140 / 400 * this.length)} ${(240 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/>
          <Path d={`M ${(140 / 400 * this.length)} ${(240 / 400 * this.length)} C ${(220 / 400 * this.length)} ${(270 / 400 * this.length)}, ${(220 / 400 * this.length)} ${(270 / 400 * this.length)}, ${(220 / 400 * this.length)} ${(270 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/>
        </>
        : <></>
        }
      </>
