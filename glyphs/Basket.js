...
export default class Basket {
  constructor(length) {
    ...
    this.numSegments = 2;
    this.line1Points = [
      [{"x": 75, "y": 177},{"x": 75, "y": 177},{"x": 325, "y": 177},{"x": 325, "y": 177},],
    ]
    this.line2Points = [
      [{"x": 75, "y": 175},{"x": 125, "y": 250},{"x": 195, "y": 240},{"x": 200, "y": 242},],
      [{"x": 200, "y": 242},{"x": 205, "y": 240},{"x": 275, "y": 250},{"x": 325, "y": 175},],
      [{"x": 325, "y": 175},{"x": 325, "y": 175},{"x": 330, "y": 205},{"x": 334, "y": 215},],
      [{"x": 334, "y": 215},{"x": 340, "y": 230},{"x": 345, "y": 235},{"x": 355, "y": 225},],
      [{"x": 355, "y": 225},{"x": 357, "y": 223},{"x": 355, "y": 205},{"x": 355, "y": 205},],
      [{"x": 355, "y": 205},{"x": 356, "y": 190},{"x": 327, "y": 176},{"x": 325, "y": 175},],
    ]
  }
  ...
  shape = (color, maxSegmentIndex, reveal) => {
    ...
    return (
      <>
        ...
        <>
          <Path d={`M ${(75 / 400 * this.length)} ${(177 / 400 * this.length)} C ${(75 / 400 * this.length)} ${(177 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(177 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(177 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
        {(maxSegmentIndex > 1 || reveal) ? 
        <>
          <Path d={`M ${(75 / 400 * this.length)} ${(175 / 400 * this.length)} C ${(125 / 400 * this.length)} ${(250 / 400 * this.length)}, ${(195 / 400 * this.length)} ${(240 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(242 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(200 / 400 * this.length)} ${(242 / 400 * this.length)} C ${(205 / 400 * this.length)} ${(240 / 400 * this.length)}, ${(275 / 400 * this.length)} ${(250 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(175 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(325 / 400 * this.length)} ${(175 / 400 * this.length)} C ${(325 / 400 * this.length)} ${(175 / 400 * this.length)}, ${(330 / 400 * this.length)} ${(205 / 400 * this.length)}, ${(334 / 400 * this.length)} ${(215 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(334 / 400 * this.length)} ${(215 / 400 * this.length)} C ${(340 / 400 * this.length)} ${(230 / 400 * this.length)}, ${(345 / 400 * this.length)} ${(235 / 400 * this.length)}, ${(355 / 400 * this.length)} ${(225 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(355 / 400 * this.length)} ${(225 / 400 * this.length)} C ${(357 / 400 * this.length)} ${(223 / 400 * this.length)}, ${(355 / 400 * this.length)} ${(205 / 400 * this.length)}, ${(355 / 400 * this.length)} ${(205 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(355 / 400 * this.length)} ${(205 / 400 * this.length)} C ${(356 / 400 * this.length)} ${(190 / 400 * this.length)}, ${(327 / 400 * this.length)} ${(176 / 400 * this.length)}, ${(325 / 400 * this.length)} ${(175 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
      </>
    )
