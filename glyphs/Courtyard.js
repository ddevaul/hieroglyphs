...
export default class Courtyard {
  constructor(length) {
    ...
    this.line1Points = [
      ...
      [{"x": 102, "y": 125},{"x": 102, "y": 125},{"x": 298, "y": 125},{"x": 298, "y": 125},],
      [{"x": 298, "y": 125},{"x": 298, "y": 125},{"x": 300, "y": 125},{"x": 300, "y": 127},],
      [{"x": 300, "y": 127},{"x": 300, "y": 127},{"x": 300, "y": 273},{"x": 300, "y": 273},],
      [{"x": 300, "y": 273},{"x": 300, "y": 273},{"x": 300, "y": 275},{"x": 298, "y": 275},],
      [{"x": 298, "y": 275},{"x": 298, "y": 275},{"x": 202, "y": 275},{"x": 202, "y": 275},],
      [{"x": 202, "y": 275},{"x": 202, "y": 275},{"x": 200, "y": 277},{"x": 200, "y": 277},],
      [{"x": 200, "y": 277},{"x": 200, "y": 277},{"x": 200, "y": 200},{"x": 200, "y": 200},],
    ]
  }
  ...
  shape = (color, maxSegmentIndex, reveal) => {
    ...
    return (
      <>
        ...
        <>
          <Path d={`M ${(100 / 400 * this.length)} ${(275 / 400 * this.length)} C ${(100 / 400 * this.length)} ${(275 / 400 * this.length)}, ${(100 / 400 * this.length)} ${(123 / 400 * this.length)}, ${(100 / 400 * this.length)} ${(123 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(100 / 400 * this.length)} ${(123 / 400 * this.length)} C ${(100 / 400 * this.length)} ${(123 / 400 * this.length)}, ${(100 / 400 * this.length)} ${(125 / 400 * this.length)}, ${(102 / 400 * this.length)} ${(125 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(102 / 400 * this.length)} ${(125 / 400 * this.length)} C ${(102 / 400 * this.length)} ${(125 / 400 * this.length)}, ${(298 / 400 * this.length)} ${(125 / 400 * this.length)}, ${(298 / 400 * this.length)} ${(125 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(298 / 400 * this.length)} ${(125 / 400 * this.length)} C ${(298 / 400 * this.length)} ${(125 / 400 * this.length)}, ${(300 / 400 * this.length)} ${(125 / 400 * this.length)}, ${(300 / 400 * this.length)} ${(127 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(300 / 400 * this.length)} ${(127 / 400 * this.length)} C ${(300 / 400 * this.length)} ${(127 / 400 * this.length)}, ${(300 / 400 * this.length)} ${(273 / 400 * this.length)}, ${(300 / 400 * this.length)} ${(273 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(300 / 400 * this.length)} ${(273 / 400 * this.length)} C ${(300 / 400 * this.length)} ${(273 / 400 * this.length)}, ${(300 / 400 * this.length)} ${(275 / 400 * this.length)}, ${(298 / 400 * this.length)} ${(275 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(298 / 400 * this.length)} ${(275 / 400 * this.length)} C ${(298 / 400 * this.length)} ${(275 / 400 * this.length)}, ${(202 / 400 * this.length)} ${(275 / 400 * this.length)}, ${(202 / 400 * this.length)} ${(275 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(202 / 400 * this.length)} ${(275 / 400 * this.length)} C ${(202 / 400 * this.length)} ${(275 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(277 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(277 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(200 / 400 * this.length)} ${(277 / 400 * this.length)} C ${(200 / 400 * this.length)} ${(277 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(200 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(200 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
      </>
    )
