...
export default class Water {
  constructor(length) {
    ...
    this.line2Points = [
      [{"x": 80, "y": 170},{"x": 80, "y": 170},{"x": 110, "y": 220},{"x": 110, "y": 220},],
      [{"x": 110, "y": 220},{"x": 110, "y": 220},{"x": 140, "y": 170},{"x": 140, "y": 170},],
      [{"x": 140, "y": 170},{"x": 140, "y": 170},{"x": 170, "y": 220},{"x": 170, "y": 220},],
      [{"x": 170, "y": 220},{"x": 170, "y": 220},{"x": 200, "y": 170},{"x": 200, "y": 170},],
      [{"x": 200, "y": 170},{"x": 200, "y": 170},{"x": 230, "y": 220},{"x": 230, "y": 220},],
      [{"x": 230, "y": 220},{"x": 230, "y": 220},{"x": 260, "y": 170},{"x": 260, "y": 170},],
      [{"x": 260, "y": 170},{"x": 260, "y": 170},{"x": 290, "y": 220},{"x": 290, "y": 220},],
      [{"x": 290, "y": 220},{"x": 290, "y": 220},{"x": 320, "y": 170},{"x": 320, "y": 170},],
      [{"x": 320, "y": 170},{"x": 320, "y": 170},{"x": 345, "y": 240},{"x": 345, "y": 240},],
    ]
  }
  ...
  shape = (color, maxSegmentIndex, reveal) => {
    ...
    return (
      <>
        ...
        <>
          <Path d={`M ${(80 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(80 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(55 / 400 * this.length)} ${(240 / 400 * this.length)}, ${(55 / 400 * this.length)} ${(240 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
        {(maxSegmentIndex > 1 || reveal) ? 
        <>
          <Path d={`M ${(80 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(80 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(110 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(110 / 400 * this.length)} ${(220 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(110 / 400 * this.length)} ${(220 / 400 * this.length)} C ${(110 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(140 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(140 / 400 * this.length)} ${(170 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(140 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(140 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(170 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(170 / 400 * this.length)} ${(220 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(170 / 400 * this.length)} ${(220 / 400 * this.length)} C ${(170 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(170 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(200 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(200 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(230 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(230 / 400 * this.length)} ${(220 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(230 / 400 * this.length)} ${(220 / 400 * this.length)} C ${(230 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(260 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(260 / 400 * this.length)} ${(170 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(260 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(260 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(290 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(290 / 400 * this.length)} ${(220 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(290 / 400 * this.length)} ${(220 / 400 * this.length)} C ${(290 / 400 * this.length)} ${(220 / 400 * this.length)}, ${(320 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(320 / 400 * this.length)} ${(170 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(320 / 400 * this.length)} ${(170 / 400 * this.length)} C ${(320 / 400 * this.length)} ${(170 / 400 * this.length)}, ${(345 / 400 * this.length)} ${(240 / 400 * this.length)}, ${(345 / 400 * this.length)} ${(240 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
