...
export default class Cloth {
  constructor(length) {
    ...
    this.line2Points = [
      [{"x": 175, "y": 125},{"x": 175, "y": 111.25},{"x": 186.25, "y": 100},{"x": 200, "y": 100},],
      [{"x": 200, "y": 100},{"x": 213.75, "y": 100},{"x": 225, "y": 111.25},{"x": 225, "y": 125},],
      [{"x": 225, "y": 125},{"x": 225, "y": 125},{"x": 225, "y": 250},{"x": 225, "y": 250},],
    ]
  }
  ...
  shape = (color, maxSegmentIndex, reveal) => {
    ...
    return (
      <>
        ...
        <>
          <Path d={`M ${(175 / 400 * this.length)} ${(125 / 400 * this.length)} C ${(175 / 400 * this.length)} ${(125 / 400 * this.length)}, ${(175 / 400 * this.length)} ${(350 / 400 * this.length)}, ${(175 / 400 * this.length)} ${(350 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
        {(maxSegmentIndex > 1 || reveal) ? 
        <>
          <Path d={`M ${(175 / 400 * this.length)} ${(125 / 400 * this.length)} C ${(175 / 400 * this.length)} ${(111.25 / 400 * this.length)}, ${(186.25 / 400 * this.length)} ${(100 / 400 * this.length)}, ${(200 / 400 * this.length)} ${(100 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(200 / 400 * this.length)} ${(100 / 400 * this.length)} C ${(213.75 / 400 * this.length)} ${(100 / 400 * this.length)}, ${(225 / 400 * this.length)} ${(111.25 / 400 * this.length)}, ${(225 / 400 * this.length)} ${(125 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
          <Path d={`M ${(225 / 400 * this.length)} ${(125 / 400 * this.length)} C ${(225 / 400 * this.length)} ${(125 / 400 * this.length)}, ${(225 / 400 * this.length)} ${(250 / 400 * this.length)}, ${(225 / 400 * this.length)} ${(250 / 400 * this.length)}`} fill="none" stroke={color} strokeWidth="5"/> 
        </>
        : <></>}
      </>
    )
